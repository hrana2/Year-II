 ...
 *  Author: Himanshu Rana - hrana2 and Jessica Valenzuela - jvalenzu
...
//copies matrix to use in variable
...
//output the distance matrix that will have the shortest path using Floyd's algorithm
...
//displays path length and the path it takes
void pathinfo() {
	for (int i = 1; i <= num_vertices; i++) {
		for (int j = 1; j <= num_vertices; j++) {
...
int main(int argc, const char *argv[]) {
	...
	// Checks for all the different types of errors there might be
